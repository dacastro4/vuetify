...
test('breakpoint.js', function (_ref) {
  ...
  var scenarios = [{
    ...
    height: 400,
    name: 'xs',
    mustBeTrue: ['xs', 'xsOnly', 'smAndDown', 'mdAndDown', 'lgAndDown']
  }, {
    ...
    height: 360,
    name: 'sm',
    mustBeTrue: ['sm', 'smOnly', 'smAndDown', 'smAndUp', 'mdAndDown', 'lgAndDown']
  }, {
    ...
    height: 768,
    name: 'md',
    mustBeTrue: ['md', 'mdOnly', 'smAndUp', 'mdAndDown', 'mdAndUp', 'lgAndDown']
  }, {
    ...
    height: 1024,
    name: 'lg',
    mustBeTrue: ['lg', 'lgOnly', 'smAndUp', 'mdAndUp', 'lgAndDown', 'lgAndUp']
  }, {
    ...
    height: 1080,
    name: 'xl',
    mustBeTrue: ['xl', 'xlOnly', 'smAndUp', 'mdAndUp', 'lgAndUp']
  }, {
  ...
  var allFlags = ['xs', 'sm', 'md', 'lg', 'xl', 'xsOnly', 'smOnly', 'smAndDown', 'smAndUp', 'mdOnly', 'mdAndDown', 'mdAndUp', 'lgOnly', 'lgAndDown', 'lgAndUp', 'xlOnly'];

  scenarios.forEach(function (scenario) {
    it('should calculate breakpoint for ' + scenario.description, function () {
      var wrapper = mount(VApp);
      wrapper.setData({
        clientWidth: scenario.width,
        clientHeight: scenario.height
      });
      var breakpoint = wrapper.vm.breakpoint;
      ...
      allFlags.forEach(function (flag) {
        var expectedValue = scenario.mustBeTrue.indexOf(flag) !== -1;
