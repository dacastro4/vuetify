...
describe.skip('colorToInt', function () {
  ...
  it('should keep existing numbers', function () {
  ...
  it('should reject invalid formats', function () {
    expect(function () {
      return colorToInt([]);
    }).toThrow('Colors can only be numbers or strings, recieved Array instead');
    expect(function () {
      return colorToInt(function () {});
    }).toThrow('Colors can only be numbers or strings, recieved Function instead');
    expect(function () {
      return colorToInt(-1);
    }).toThrow('Colors cannot be negative: \'-1\'');
    expect(function () {
      return colorToInt('#1000000');
    }).toThrow('\'#1000000\' is not a valid rgb color');
    // TODO:
    expect(function () {
      return colorToInt('#13');
    }).toThrow('\'#13\' is not a valid rgb color');
    expect(function () {
      return colorToInt('#6');
    }).toThrow('\'#6\' is not a valid rgb color');
  });
});
...
describe('transformSRGB', function () {
  it('should convert sRGB to XYZ', function () {
  ...
  it('should convert XYZ to sRGB', function () {
...
describe('transformCIELAB', function () {
  it('should convert LAB to XYZ', function () {
...
expect.extend({
  toEqualCloseTo: function toEqualCloseTo(received, expected) {
